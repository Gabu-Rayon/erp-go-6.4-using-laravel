                ...
                <div class="container">
                    <div class="apply-job-wrapper bg-light">
                        <div class="section-title text-center">
                            ...
                            <a href="<?php echo e(route('job.apply',[$job->code,$currantLang])); ?>" class="btn btn-primary rounded"><?php echo e(__('Apply now')); ?> <i class="ti ti-send ms-2"></i> </a>
                        </div>
...
<?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/job/requirement.blade.php ENDPATH**/ ?>