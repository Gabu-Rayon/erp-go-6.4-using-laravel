    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <span class="text-danger">*</span>
                <?php echo e(Form::datetime('confirmDate', $invoiceDue->confirmDate, array('class' => 'form-control', 'required' => 'required'))); ?>
            ...
            <div class="form-group col-md-3">
                ...
                <?php echo e(Form::datetime('stockReleseDate', $invoiceDue->stockReleaseDate, array('class' => 'form-control'))); ?>
            ...
            <div class="form-group col-md-3">
                ...
                <span class="text-danger">*</span>
                <?php echo e(Form::datetime('receiptPublishDate', $invoiceDue->receipt_RcptPbctDt, array('class' => 'form-control', 'required' => 'required'))); ?>
