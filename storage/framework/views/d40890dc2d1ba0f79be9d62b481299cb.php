...
<?php $__env->startPush('script-page'); ?>
    ...
    <script type="text/javascript">
        ...
        <?php if($admin_payment_setting['is_payfast_enabled'] == 'on' && !empty($admin_payment_setting['payfast_merchant_id']) && !empty($admin_payment_setting['payfast_merchant_key'])): ?>
            $(document).ready(function() {
                    ...
                    <div class="sticky-top" style="top:30px">
                            ...
                            <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s" style="
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-4 f-w-600  ">
                                        <?php echo e((isset($admin_payment_setting['currency_symbol'])) ? $admin_payment_setting['currency_symbol'] : '$'); ?><?php echo e($plan->price . ' / ' . __(\App\Models\Plan::$arrDuration[$plan->duration])); ?></small>
                                        </small>
                                    </h3>
                        ...
                        <div class="card ">
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                <?php if($admin_payment_setting['is_manually_payment_enabled'] == 'on'): ?>
                                    <a href="#send_request"
                                       class="list-group-item list-group-item-action border-0 active"><?php echo e(__('Manually')); ?>

                                        <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                    </a>
                                <?php endif; ?>
                                <?php if($admin_payment_setting['is_bank_transfer_enabled'] == 'on' && !empty($admin_payment_setting['bank_details'])): ?>
                                    <a href="#bank_payment"
                                ...
                                <?php if(isset($admin_payment_setting['is_razorpay_enabled']) && $admin_payment_setting['is_razorpay_enabled'] == 'on'): ?>
                                    <a href="#razorpay_payment"
                                       class="list-group-item list-group-item-action border-0"><?php echo e(__('Razorpay')); ?>
                                ...
                                <?php if(isset($admin_payment_setting['is_mollie_enabled']) && $admin_payment_setting['is_mollie_enabled'] == 'on'): ?>
                                    <a href="#mollie_payment"
                                       class="list-group-item list-group-item-action border-0"><?php echo e(__('Mollie')); ?>
                                ...
                                <?php if(isset($admin_payment_setting['is_skrill_enabled']) && $admin_payment_setting['is_skrill_enabled'] == 'on'): ?>
                                    <a href="#skrill_payment"
                                       class="list-group-item list-group-item-action border-0"><?php echo e(__('Skrill')); ?>
                                ...
                                <?php if(isset($admin_payment_setting['is_coingate_enabled']) && $admin_payment_setting['is_coingate_enabled'] == 'on'): ?>
                                    <a href="#coingate_payment"
                                       class="list-group-item list-group-item-action border-0"><?php echo e(__('Coingate')); ?>
                ...
                <div class="col-xl-9">
                    ...
                    <?php if($admin_payment_setting['is_manually_payment_enabled'] == 'on'): ?>
                        <div id="send_request" class="card">
                            <div class="card-header"><h5><?php echo e(__('Manually')); ?></h5></div>
                            <div class="tab-pane <?php echo e(($admin_payment_setting['is_manually_payment_enabled'] == 'on') == 'on'? 'active': ''); ?>" id="send_request">
                                        ...
                                        <?php if($plan->id != 1 && $plan->id != \Auth::user()->plan): ?>
                                            <?php if(\Auth::user()->requested_plan != $plan->id): ?>
                                                <a href="<?php echo e(route('send.request',[\Illuminate\Support\Facades\Crypt::encrypt($plan->id)])); ?>"
                                                   class="btn btn-primary mb-2 me-3" data-title="<?php echo e(__('Send Request')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Send Request')); ?>">
                                                    <span class="btn-inner--icon"><?php echo e(__('Send Request')); ?></span>
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('request.cancel',\Auth::user()->id)); ?>" class="btn btn-danger mb-2 me-3"
                                                   data-title="<?php echo e(__('Cancle Request')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Cancle Request')); ?>">
                                                    <span class="btn-inner--icon"><?php echo e(__('Cancle Request')); ?></span>
                                                </a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </div>
                    ...
                    <?php if($admin_payment_setting['is_bank_transfer_enabled'] == 'on' && !empty($admin_payment_setting['bank_details'])): ?>
                        <div id="bank_payment" class="card">
                            <div class="card-header"><h5><?php echo e(__('Bank Transfer')); ?></h5></div>
                            <div class="tab-pane <?php echo e(($admin_payment_setting['is_bank_transfer_enabled'] == 'on' &&!empty($admin_payment_setting['bank_details'])) == 'on'? 'active': ''); ?>" id="bank_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.bank')); ?>" method="post" class="require-validation" id="bank-payment-form" enctype = "multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="border p-3 rounded bank-payment-div">
                                        <div class="row">
                                            <div class="col-6 ">
                                                <div class="custom-radio">
                                                    <label class="font-16 font-bold"><?php echo e(__('Bank Details')); ?> :</label>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="bank_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                                    <div class="form-group ms-3 mt-4">
                                                        <a href="#" class="text-muted " data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="custom-radio">
                                                    <label class="font-16 font-bold"><?php echo e(__('Net Amount')); ?> : </label>
                                                    <span class="final-price"><?php echo e((isset($admin_payment_setting['currency_symbol'])) ? $admin_payment_setting['currency_symbol'] : '$'); ?><?php echo e($plan->price); ?></span>
                                                </div>
                                    ...
                                    <div class="col-sm-12 my-2 px-2">
                                        <div class="text-end">
                                            ...
                                            <input type="submit" value="<?php echo e(__('Pay Now')); ?>" class="btn btn-primary mb-2 me-3">
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <?php if($admin_payment_setting['is_stripe_enabled'] == 'on' && !empty($admin_payment_setting['stripe_key']) && !empty($admin_payment_setting['stripe_secret'])): ?>
                        ...
                        <div class="card-header"><h5><?php echo e(__('Stripe')); ?></h5></div>
                                    ...
                                    <div class="border p-3 rounded stripe-payment-div">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        <label for="stripe_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="error" style="display: none;">
                                                    <div class='alert-danger alert'><?php echo e(__('Please correct the errors and try again.')); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mt-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-group ms-3 mt-4">
                                                            <a class="text-muted " data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div id="paystack-payment" class="tabs-card">
                                <div class="">
                                    <form class="w3-container w3-display-middle w3-card-4" method="POST" id="paystack-payment-form"
                                        ...
                                        <div class="border p-3 mb-3 rounded">
                                            <div class="row">
                                                <div class="col-md-12 mt-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="form-group w-100">
                                                            <label for="paystack_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                            <input type="text" id="paystack_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                        </div>

                                                        <div class="form-group ms-3 mt-4">
                                                            <a  class="text-muted " data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>">
                                        ...
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                <input type="button"  id="pay_with_paystack" value="<?php echo e(__('Pay Now')); ?>" class="btn btn-primary mb-2 me-3">
                                            </div>
                                        </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_flutterwave_enabled']) && $admin_payment_setting['is_flutterwave_enabled'] == 'on'): ?>
                        <div id="flutterwave_payment" class="card">
                            ...
                            <div class="tab-pane " id="flutterwave_payment">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST" id="flaterwave-payment-form" action="<?php echo e(route('plan.pay.with.flaterwave')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="plan_id" value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            ...
                                            <div class="d-flex align-items-center">
                                            <div class="form-group w-100">
                                                <label for="flutterwave_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                <input type="text" id="flutterwave_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                            </div>
                                            <div class="form-group ms-3 mt-4">
                                                <a class="text-muted " data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                </a>
                                    ...
                                    <div class="col-sm-12 my-2 px-2">
                                        <div class="text-end">
                                            <input id="pay_with_flaterwave" type="button" value="<?php echo e(__('Pay Now')); ?>" class="btn btn-primary mb-2 me-3">
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_razorpay_enabled']) && $admin_payment_setting['is_razorpay_enabled'] == 'on'): ?>
                        <div id="razorpay_payment" class="card">
                            ...
                            <div class="tab-pane " id="razorpay_payment">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST" id="razorpay-payment-form" action="<?php echo e(route('plan.pay.with.razorpay')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="plan_id" value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="razorpay_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                    ...
                                    <div class="col-sm-12 my-2 px-2">
                                        <div class="text-end">
                                            <input type="button" id="pay_with_razorpay" value="<?php echo e(__('Pay Now')); ?>" class="btn btn-primary mb-2 me-3">
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_mercado_enabled']) && $admin_payment_setting['is_mercado_enabled'] == 'on'): ?>
                        <div id="mercado_payment" class="card">
                            ...
                            <div class="tab-pane " id="mercado_payment">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST" id="payment-form" action="<?php echo e(route('plan.pay.with.mercado')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="plan_id" value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                                ...
                                                <div class="border p-3 mb-3 rounded payment-box">
                                                    <div class="d-flex align-items-center">
                                                        <div class="form-group w-100">
                                                            ...
                                                            <input type="text" id="mercado_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                        </div>
                                    ...
                                    <div class="col-sm-12 my-2 px-2">
                                        <div class="text-end">
                                            <input type="submit" id="pay_with_mercado" value="<?php echo e(__('Pay Now')); ?>" class="btn btn-primary mb-2 me-3">
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div id="paytm_payment" class="card">
                            ...
                            <div class="tab-pane " id="paytm_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.paytm')); ?>" method="post" class="require-validation" id="paytm-payment-form">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="plan_id" value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                    <input type="hidden" name="total_price" id="paytm_total_price" value="<?php echo e($plan->price); ?>" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mobile_number" name="mobile_number" class="form-control coupon" placeholder="<?php echo e(__('Enter Mobile Number')); ?> " required>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="form-group w-100">
                                                    <label for="paytm_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                    <input type="text" id="paytm_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                </div>
                        ...
                        <div id="mollie_payment" class="card">
                            ...
                            <div class="tab-pane " id="mollie_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.mollie')); ?>" method="post" class="require-validation" id="mollie-payment-form">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="plan_id" value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                    <input type="hidden" name="total_price" id="mollie_total_price" value="<?php echo e($plan->price); ?>" class="form-control">
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="mollie_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                                    <div class="form-group ms-3 mt-4">
                                                        <a  class="text-muted " data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                        </a>
                        ...
                        <div id="skrill_payment" class="card">
                            ...
                            <div class="tab-pane " id="skrill_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.skrill')); ?>" method="post" class="require-validation" id="skrill-payment-form">
                                    ...
                                    ?>
                                    <input type="hidden" name="plan_id" value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                    <input type="hidden" name="total_price" id="skrill_total_price" value="<?php echo e($plan->price); ?>" class="form-control">
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        <label for="skrill_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                        <input type="text" id="skrill_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                                    <div class="form-group ms-3 mt-4">
                                                        <a class="text-muted " data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                        </a>
                        ...
                        <div id="coingate_payment" class="card">
                            ...
                            <div class="tab-pane " id="coingate_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.coingate')); ?>" method="post" class="require-validation" id="coingate-payment-form">
                                    ...
                                    <input type="hidden" name="plan_id" value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                    <input type="hidden" name="total_price" id="coingate_total_price" value="<?php echo e($plan->price); ?>" class="form-control">
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        <label for="coingate_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                        <input type="text" id="coingate_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                                    <div class="form-group ms-3 mt-4">
                                                        <a class="text-muted " data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                        </a>
                    ...
                    <?php if(isset($admin_payment_setting['is_paymentwall_enabled']) && $admin_payment_setting['is_paymentwall_enabled'] == 'on'): ?>
                        <div id="paymentwall_payment" class="card">
                            ...
                            <div class="tab-pane " id="paymentwall_payment">
                                <form role="form" action="<?php echo e(route('plan.paymentwallpayment')); ?>" method="post" id="paymentwall-payment-form" class="w3-container w3-display-middle w3-card-4">
                                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="paymentwall_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        <label for="toyyibpay_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                        <input type="text" id="toyyibpay_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_payfast_enabled']) && $admin_payment_setting['is_payfast_enabled'] == 'on'): ?>
                        <div id="payfast_payment" class="card">
                            ...
                            <?php if($admin_payment_setting['is_payfast_enabled'] == 'on' && !empty($admin_payment_setting['payfast_merchant_id']) && !empty($admin_payment_setting['payfast_merchant_key']) && !empty($admin_payment_setting['payfast_signature']) && !empty($admin_payment_setting['payfast_mode'])): ?>
                                <div class="tab-pane <?php echo e(($admin_payment_setting['is_payfast_enabled'] == 'on' && !empty($admin_payment_setting['payfast_merchant_id']) && !empty($admin_payment_setting['payfast_merchant_key'])) == 'on' ? 'active' : ''); ?>">
                                    <?php
                                    ...
                                    <form role="form" action=<?php echo e('https://' . $pfHost . '/eng/process'); ?> method="post"
                                        ...
                                        <div class="border p-3 mb-3 rounded">
                                            <div class="row">
                                                <div class="col-md-12 mt-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="form-group w-100">
                                                            <label for="payfast_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                            <input type="text" id="payfast_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                        </div>
                                                        <div class="form-group ms-3 mt-4">
                                                            <a class="text-muted apply-coupon" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                <input type="hidden" name="plan_id" id="plan_id" value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                                <input type="submit" value="<?php echo e(__('Pay Now')); ?>" id="payfast-get-status" class="btn btn-primary mb-2 me-3">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_iyzipay_enabled']) && $admin_payment_setting['is_iyzipay_enabled'] == 'on'): ?>
                        <div class="card" id="iyzipay-payment">
                            ...
                            <div class="tab-pane" id="iyzipay-payment">
                                <form role="form" action="<?php echo e(route('iyzipay.payment.init')); ?>" method="post" class="require-validation" id="iyzipay-payment-form">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        <label for="iyzipay_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                        <input type="text" id="iyzipay_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                                    <div class="form-group ms-3 mt-4">
                                                        <a class="text-muted apply-coupon" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                        </a>
                                             ...
                                             <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="sspay_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="paytab_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="benefit_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="cashfree_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="aamarpay_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_paytr_enabled']) && $admin_payment_setting['is_paytr_enabled'] == 'on'): ?>
                        <div id="paytr_payment" class="card">
                            ...
                            <div class="tab-pane" id="paytr_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.paytr',$plan->id)); ?>" method="post"
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="paytr_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_yookassa_enabled']) && $admin_payment_setting['is_yookassa_enabled'] == 'on'): ?>
                        <div id="yookassa_payment" class="card">
                            ...
                            <div class="tab-pane" id="yookassa_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.yookassa',$plan->id)); ?>" method="post"
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        <label for="yookassa_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                        <input type="text" id="yookassa_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_midtrans_enabled']) && $admin_payment_setting['is_midtrans_enabled'] == 'on'): ?>
                        <div id="midtrans_payment" class="card">
                            ...
                            <div class="tab-pane" id="midtrans_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.midtrans',$plan->id)); ?>" method="post"
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        <label for="midtrans_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                        <input type="text" id="midtrans_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                    </div>
                    ...
                    <?php endif; ?>
                     ...
                     <div id="xendit_payment" class="card">
                         ...
                         <div class="tab-pane" id="xendit_payment">
                             <form role="form" action="<?php echo e(route('plan.pay.with.xendit',$plan->id)); ?>" method="post"
                                         ...
                                         <div class="col-md-12 mt-4">
                                             <div class="d-flex align-items-center">
                                                 <div class="form-group w-100">
                                                     ...
                                                     <input type="text" id="xendit_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                                 </div>
                 ...
                 <div id="nepalste_payment" class="card">
                     ...
                     <div class="tab-pane" id="nepalste_payment">
                         <form role="form" action="<?php echo e(route('plan.pay.with.nepalste',$plan->id)); ?>" method="post"
                             ...
                             <div class="border p-3 mb-3 rounded">
                                 <div class="row">
                                     <div class="col-md-12 mt-4">
                                         <div class="d-flex align-items-center">
                                             <div class="form-group w-100">
                                                 <label for="nepalste_coupon" class="form-label"><?php echo e(__('Coupon')); ?></label>
                                                 <input type="text" id="nepalste_coupon" name="coupon" class="form-control coupon" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                             </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/stripe.blade.php ENDPATH**/ ?>