...
<div class="modal-body">
    ...
    <div class="form-group col-md-6">
        ...
        <?php if($support->attachment): ?>
            <img id="image" class="mt-2" src="<?php echo e(asset(Storage::url('uploads/supports')).'/'.$support->attachment); ?>" style="width:25%;"/>
        <?php endif; ?>
...
<?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/support/edit.blade.php ENDPATH**/ ?>