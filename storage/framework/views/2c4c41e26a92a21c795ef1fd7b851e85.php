...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <div class="d-inline-block mb-4">
            <!-- <?php echo e(Form::open(['url' => 'invoice.no.getSalesByTraderInvoiceNo', 'class' => 'w-100'])); ?> -->
            <?php echo e(Form::open(['route' => 'invoice.no.getSalesByTraderInvoiceNo', 'method' => 'GET', 'class' => 'w-100'])); ?>
            ...
            <div class="form-group">
                ...
                <?php echo e(Form::number('getSalesByTraderInvoiceNo', null, ['class' => 'form-control', 'placeholder' => '1', 'required' => 'required'])); ?>
...
<script>
    ...
    sync.addEventListener('click', async function(event) {
        ...
        if (!inputValue) {
            alert('<?php echo e(__('Please enter Invoice No to search by e.g. 10')); ?>');
            return;
        }
        ...
        try {
            ...
            const response = await fetch(
                `<?php echo e(route('invoice.no.getSalesByTraderInvoiceNo')); ?>?getSalesByTraderInvoiceNo=${inputValue}`, {
                    method: 'GET',
                    headers: {
            ...
            if (!response.ok) {
                throw new Error('<?php echo e(__('An error occurred while syncing the data Sales Invoices')); ?>');
            }
            ...
            if (data.error) {
                ...
                showErrorPopup('<?php echo e(__('Invoice Already existing. No New Invoices data added.')); ?>');
            }
        } catch (error) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\Desktop\chrisdroid\projects\erp-go-6.4-using-laravel\resources\views/invoice/index.blade.php ENDPATH**/ ?>