        ...
        if (res.flag == 1) {
            ...
            var x = getpaidSetup({
                ...
                txref: nowTim + '__' + Math.floor((Math.random() * 1000000000)) +
                    'fluttpay_online-' + '<?php echo e(date('Y-m-d')); ?>' + '?amount=' +
                    amount,
                meta: [{
                    metaname: "payment_id",
                    metavalue: "id"
...
<div class="row">
            ...
            <div class="card-body">
                <div class="row timeline-wrapper">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        ...
                        <p class="text-muted text-sm mb-3"><?php echo e(__('Status')); ?> :
                            <?php echo e(__('Awaiting payment')); ?> </p>
                        <?php if($invoice->status != 0): ?>
    ...
    <<<<<<< HEAD <?php endif; ?> <?php endif; ?> <?php if(Gate::check('show invoice')): ?>
        <?php if($invoice->status != 0): ?> <div class="row justify-content-between align-iteams-center mb-3">
                            ...
                            <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                <h4 class="invoice-number">
                                    <<<<<<< HEAD
                                        ...
                                        =======
                                        <?php echo e($invoice->response_invoiceNo); ?>
                                </h4>
                                >>>>>>> Purchase
                            </div>
                            <div class="col-12">
                            ...
                            <<<<<<< HEAD=======<!-- <?php
                                ...
                                <div class="col ">
                                    <small>
                                        ...
                                        <p><i>Date : </i><?php echo e($invoice->response_SdcDateTime); ?></p>
                                        <p><i>Invoice No : </i><?php echo e($invoice->response_invoiceNo); ?></p>
                                        <p><i>Trader Invoice No :
                                            </i><?php echo e($invoice->response_trderInvoiceNo); ?></p>
                                        <p><i>Internal Data : </i><?php echo e($invoice->response_IntrlData); ?></p>
                                        <p><i>Receipt Signature : </i><?php echo e($invoice->response_RcptSign); ?></p>
                                    </small>
                                </div>
                                >>>>>>> Purchase
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive mt-2">
                                    <table class="table mb-0 table-striped">
                                        ...
                                        <?php echo e(\Log::info('iteam(item)')); ?>
                                        ...
                                        <td><?php echo e(!empty($iteam->pkgQuantity) ? $iteam->pkgQuantity : ''); ?>
                                        </td>
                                        <td>Kes
                                            <?php echo e($iteam->unitPrice * $iteam->pkgQuantity * $iteam->quantity); ?>

                                        </td>
                                        <td><?php echo e(!empty($iteam->discountAmt) ? $iteam->discountAmt : ''); ?>
                                        </td>
                                        <td>
                                            <?php
