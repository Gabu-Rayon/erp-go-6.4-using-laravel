                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <?php echo e(Form::text('customerName', '', array('class' => 'form-control','required'=>'required'))); ?>

                        </div>
                        <div class="form-group col-md-4">
                            <?php echo e(Form::label('customerTin', __('Customer TIN (*)'),['class'=>'form-label'])); ?>

                            <?php echo e(Form::text('customerTin', '', array('class' => 'form-control','required'=>'required'))); ?>

                        </div>
                        <div class="form-group col-md-4">
                            <?php echo e(Form::label('customerNo', __('Customer Number'),['class'=>'form-label'])); ?>

                            <?php echo e(Form::number('customerNo', '', array('class' => 'form-control'))); ?>

                        </div>
                        <div class="form-group col-md-4">
                            <?php echo e(Form::label('customerMobileNo', __('Customer Mobile Number'),['class'=>'form-label'])); ?>

                            <?php echo e(Form::text('customerMobileNo', '', array('class' => 'form-control'))); ?>

                        </div>
                        <div class="form-group col-md-4">
                            <?php echo e(Form::label('salesType', __('Sales Type'),['class'=>'form-label'])); ?>

                            <?php echo e(Form::text('salesType', '', array('class' => 'form-control'))); ?>

                        </div>
                        <div class="form-group col-md-4">
                            <?php echo e(Form::label('paymentType', __('Payment Type'),['class'=>'form-label'])); ?>

                            <?php echo e(Form::text('paymentType', '', array('class' => 'form-control'))); ?>

                        </div>
                        <div class="form-group col-md-4">
                            <?php echo e(Form::label('traderInvoiceNo', __('Trader Invoice Number (*)'),['class'=>'form-label'])); ?>

                            <?php echo e(Form::text('traderInvoiceNo', '', array('class' => 'form-control','required'=>'required'))); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <?php echo e(Form::text('invoiceStatusCode', '', array('class' => 'form-control'))); ?>

                        </div>
                        <div class="form-group col-md-4">
                            <?php echo e(Form::label('isPurchaseAccept', __('Purchase Accepted'),['class'=>'form-label'])); ?>

                            <?php echo e(Form::select('isPurchaseAccept', array('true' => 'True', 'false' => 'False'), null, array('class' => 'form-control'))); ?>

                        </div>
                        <div class="form-group col-md-4">
                            <?php echo e(Form::label('isStockIOUpdate', __('Stock IO Update'),['class'=>'form-label'])); ?>

                            <?php echo e(Form::select('isStockIOUpdate', array('true' => 'True', 'false' => 'False'), null, array('class' => 'form-control'))); ?>
                    ...
                    <div data-repeater-list="items" class="card-body">
                        <div data-repeater-item class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <?php echo e(Form::select('isrcAplcbYn', array('true' => 'True', 'false' => 'False'), null, array('class' => 'form-control'))); ?>

                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('pkgUnitCode', __('Package Unit Code'),['class'=>'form-label'])); ?>

                                <?php echo e(Form::number('pkgUnitCode', '', array('class' => 'form-control package-unit-code', 'readonly' => 'readonly'))); ?>

                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('pkgQuantity', __('Package Quantity (*)'),['class'=>'form-label'])); ?>

                                <?php echo e(Form::number('pkgQuantity', '', array('class' => 'form-control', "required" => "required"))); ?>

                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('qtyUnitCd', __('Quantity Unit Code'),['class'=>'form-label'])); ?>

                                <?php echo e(Form::text('qtyUnitCd', '', array('class' => 'form-control quantity-unit-code', 'readonly' => 'readonly'))); ?>

                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('qty', __('Quantity (*)'),['class'=>'form-label'])); ?>

                                <?php echo e(Form::number('qty', '', array('class' => 'form-control', "required" => "required"))); ?>

                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('discountRate', __('Discount Rate'),['class'=>'form-label'])); ?>

                                <?php echo e(Form::text('discountRate', '', array('class' => 'form-control'))); ?>

                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('discountAmt', __('Discount Amount'),['class'=>'form-label'])); ?>

                                <?php echo e(Form::text('discountAmt', '', array('class' => 'form-control'))); ?>

                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('itemExprDate', __('Item Expiry Date'),['class'=>'form-label'])); ?>

                                <?php echo e(Form::date('itemExprDate', '', array('class' => 'form-control'))); ?>
