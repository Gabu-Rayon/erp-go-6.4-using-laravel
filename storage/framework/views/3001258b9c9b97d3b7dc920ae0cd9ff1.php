...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <div class="d-inline-block mb-4">
            <?php echo e(Form::open(['route' => 'productservice.searchByDate', 'method' => 'POST', 'class' => 'w-100'])); ?>
        ...
        <a href="<?php echo e(route('productservice.synchronize')); ?>" class="btn btn-sm btn-primary sync" data-bs-toggle="tooltip"
                                            ...
                                            <td>
                                                ...
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                        ...
                                                        data-title="<?php echo e(__('Edit Product Service Info')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/erp-go-6.4-using-laravel/resources/views/productservice/index.blade.php ENDPATH**/ ?>