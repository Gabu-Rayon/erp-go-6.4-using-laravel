        ...
        <table>
            <tbody>
                ...
                <td>
                    ...
                    <?php echo e(\Log::info('VENDERRR')); ?>

                    <?php echo e(\Log::info($vendor)); ?>
                ...
                <?php if(isset($purchase->itemData) && count($purchase->itemData) > 0): ?>
                    <?php $__currentLoopData = $purchase->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>KES <?php echo e($item->price); ?></td>
                            <td>KES <?php echo e(($item->discount!=0)? $item->discount :'-'); ?></td>
                            <td>KES <?php echo e($item->tax); ?></td>
                            <td><?php echo e($item->totAmt); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </tbody>
...
<?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/purchase/templates/template1.blade.php ENDPATH**/ ?>