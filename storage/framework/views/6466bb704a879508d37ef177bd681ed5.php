...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('batchNo', __('Item Bar Code'), ['class' => 'form-label'])); ?>

                <?php echo e(Form::text('bcd', null, ['class' => 'form-control', 'placeholder' => __('Enter Item Batch No')])); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('isrcAplcbYn', [true => 'Yes', false => 'No'], $productServiceinformation->isrcAplcbYn, ['class' => 'form-control select2', 'required' => 'required'])); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('isUsed', [true => 'Yes', false => 'No'], $productServiceinformation->isUsed, ['class' => 'form-control select2', 'required' => 'required'])); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/erp-go-6.4-using-laravel/resources/views/productservice/edit.blade.php ENDPATH**/ ?>