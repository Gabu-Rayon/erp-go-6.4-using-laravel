...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end m-2">
        <a href="<?php echo e(route('stockmove.index')); ?>" class="btn btn-sm btn-info">
            <?php echo e(__('Back')); ?>

        </a>
    </div>
    <div class="float-end m-2">
        <a href="<?php echo e(route('stockmove.index', $stockMove->id)); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="<?php echo e(__('Cancel')); ?>">
            <?php echo e(__('Cancel')); ?>

        </a>
    </div>
    <div class="float-end m-2">
        <a href="<?php echo e(route('stockmove.edit', $stockMove->id)); ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="<?php echo e(__('Cancel')); ?>">
            <?php echo e(__('Stock Move')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            <?php echo e(Form::open(['url' => 'stockmove', 'enctype' => 'multipart/form-data'])); ?>

            <div class="modal-body">
                <div class="row">
                    <div class="col-md-3">
                        <h6><?php echo e(__('Customer TIN: ')); ?></h6>
                        <p><?php echo e($stockMove->custTin); ?></h6>
                    </div>
                    <div class="col-md-3">
                        <h6><?php echo e(__('Customer Branch ID: ')); ?></h6>
                        <p><?php echo e($stockMove->custBhfId); ?></h6>
                    </div>
                    <div class="col-md-3">
                        <h6><?php echo e(__('Sar NO: ')); ?></h6>
                        <p><?php echo e($stockMove->sarNo); ?></h6>
                    </div>
                    <div class="col-md-3">
                        <h6><?php echo e(__('OCRN Date: ')); ?></h6>
                        <p><?php echo e($stockMove->ocrnDt); ?></h6>
                    </div>
                    <div class="col-md-3">
                        <h6><?php echo e(__('Total Item Count: ')); ?></h6>
                        <p><?php echo e($stockMove->totItemCnt); ?></h6>
                    </div>
                    <div class="col-md-3">
                        <h6><?php echo e(__('Total Taxable Amount: ')); ?></h6>
                        <p><?php echo e($stockMove->totTaxblAmt); ?></h6>
                    </div>
                    <div class="col-md-3">
                        <h6><?php echo e(__('Total Tax Amount: ')); ?></h6>
                        <p><?php echo e($stockMove->totTaxAmt); ?></h6>
                    </div>
                    <div class="col-md-12">
                        <h6><?php echo e(__('Remark: ')); ?></h6>
                        <p><?php echo e($stockMove->remark); ?></h6>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title">Items</h6>
                        <?php $__currentLoopData = $stockMoveItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/stockinfo/show.blade.php ENDPATH**/ ?>