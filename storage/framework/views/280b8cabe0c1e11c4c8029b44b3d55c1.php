...
<div class="proposal-preview-main" id="boxes">
    <div class="proposal-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?> "><?php echo e(__('PROPOSAL')); ?></h3>
                ...
                <td class="text-right">
                    <img class="proposal-logo"  src="<?php echo e($img); ?>"
                         alt="">
                    <p>
...
<?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/proposal/templates/template5.blade.php ENDPATH**/ ?>