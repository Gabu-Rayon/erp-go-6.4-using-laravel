    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '.itemCode', async function() {
                const el = $(this);
                const id = $(this).val();
                const url = `http://localhost:3000/getitem/${id}`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chris-droid/Desktop/projects/erp-go-6.4-using-laravel/resources/views/invoice/create.blade.php ENDPATH**/ ?>