                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <!-- Show Success -->
                                                <span
                                                    class="purchase_status badge bg-warning p-2 px-3 rounded">Completed</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($purchase->status == 0): ?>
                                                <span
                                                    class="purchase_status badge bg-secondary p-2 px-3 rounded">Draft</span>
                                                ...
                                                <?php elseif($purchase->isDbImport == 0): ?>
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="<?php echo e(route('purchase.details', ['spplrInvcNo' => $purchase->spplrInvcNo])); ?>"
                                                            ...
                                                            data-bs-toggle="tooltip" title="<?php echo e(__('Map Purchase')); ?>"
                                                            data-original-title="<?php echo e(__('Detail')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\projects\erp-go-6.4-using-laravel\resources\views/purchase/index.blade.php ENDPATH**/ ?>