...
<div class="response" >
    <a class="btn btn-primary btn-sm float-left" href="#!" id="regenerate"><?php echo e(__('Re Generate')); ?></a>
    <a href="#!" onclick="copyGrammerText()" class="btn btn-primary btn-sm float-end "><i class="ti ti-copy"></i> <?php echo e(__('Copy Text')); ?></a>
...
<script>
    ...
    $('body').on('click','#regenerate',function(){
        ...
        $.ajax({
            type:'post',
            url : '<?php echo e(route('grammar.response')); ?>',
            datType: 'json',
            data:form.serialize(),
            ...
            afterSend: function(msg){
                $("#regenerate").empty();
                var html = `<a class="btn btn-primary" href="#!" id="regenerate"><?php echo e(__('Generate')); ?></a>`;
...
<?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/template/grammar_ai.blade.php ENDPATH**/ ?>