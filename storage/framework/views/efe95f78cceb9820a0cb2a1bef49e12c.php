        ...
        function getDepartment(bid) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#department_id').empty();
                    $("#department_div").html('');
                    $('#department_div').append('<label for="department" class="form-label"><?php echo e(__('Department')); ?></label><select class="form-control select2" id="department_id" name="department_id[]"  ></select>');
        ...
        function getEmployee(did) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#employee_id').empty();
                    $("#employee_div").html('');
                    $('#employee_div').append('<label for="employee" class="form-label"><?php echo e(__('Employee')); ?></label><select class="form-control select2" id="employee_id" name="employee_id[]"  multiple></select>');
                                ...
                                <div class="row">
                                        ...
                                        <div class="btn-box">
                                            ...
                                            <select class="form-control select2" name="branch_id" id="branch_id"  placeholder="Select Branch" required>
                                                ...
                                                <?php $__currentLoopData = $branch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($branch->bhfId); ?>"><?php echo e($branch->bhfNm); ?></option>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box" id="department_div">
                                            ...
                                            <select class="form-control select2" name="department_id[]" id="department_id" required="required" placeholder="Select Department" >
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/report/monthlyAttendance.blade.php ENDPATH**/ ?>