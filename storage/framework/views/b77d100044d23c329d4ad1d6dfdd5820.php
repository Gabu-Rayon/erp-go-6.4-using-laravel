                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <?php else: ?>
                                <p><?php echo e(__('You have  Finish Products or Service s')); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody class="ui-sortable" data-repeater-item data-clone>
                                <tr>
                                    <td class="form-group col-md-4">
                                        ...
                                        <?php else: ?>
                                            <p><?php echo e(__('You have No Raw Material Products !')); ?></p>
                                        <?php endif; ?>
                                    </td>
                                    <td class="form-group col-md-4">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/erp-go-6.4-using-laravel/resources/views/compositionlist/create.blade.php ENDPATH**/ ?>