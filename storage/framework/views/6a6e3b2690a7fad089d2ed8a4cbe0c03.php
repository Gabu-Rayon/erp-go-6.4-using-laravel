            ...
            <div class="table-responsive">
                <table class="table datatable">
                    <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><h6><?php echo e($plan->name); ?> (<?php echo e(($admin_payment_setting['currency']) ? $admin_payment_setting['currency'] : '$'); ?><?php echo e($plan->price); ?>) <?php echo e(' / '. $plan->duration); ?></h6></td>
...
<?php /**PATH C:\Users\hp\Desktop\projects\erp-go-6.4-using-laravel\resources\views/user/plan.blade.php ENDPATH**/ ?>