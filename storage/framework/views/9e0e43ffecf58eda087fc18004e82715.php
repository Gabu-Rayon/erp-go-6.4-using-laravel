    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('pkgQuantity', null, ['class' => 'form-control', 'placeholder' => __('Enter Item Package Quantity')])); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('isrcAplcbYn', [true => 'Yes', false => 'No'], $productServiceinformation->isrcAplcbYn, ['class' => 'form-control', 'required' => 'required'])); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('isUsed', [true => 'Yes', false => 'Yes'], $productServiceinformation->isUsed, ['class' => 'form-control', 'required' => 'required'])); ?>
