        ...
        <div class="bill-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
            <table>
                <tbody>
                    <tr>
                        <td>
                            <?php echo e(Log::info('IMAGEE')); ?>

                            <?php echo e(Log::info($img)); ?>

                            <img class="bill-logo" src="<?php echo e(asset($img)); ?>" alt="">
                        </td>
                        <td class="text-right">
                            ...
                            <table class="no-space" style="width: 45%;margin-left: auto;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo e(Utility::dateFormat($settings, $bill->due_date)); ?>
...
<?php /**PATH /home/chris-droid/Desktop/projects/erp-go-6.4-using-laravel/resources/views/bill/templates/template1.blade.php ENDPATH**/ ?>