                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                     <?php echo e(Form::label('paymentType', __('Item Type Code'), ['class' => 'form-label'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/erp-go-6.4-using-laravel/resources/views/invoice/create.blade.php ENDPATH**/ ?>