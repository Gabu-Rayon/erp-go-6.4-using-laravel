...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('remark',null,array('class'=>'form-control','placeholder'=>__('Enter your Remark'),'required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
         ...
         <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('email',null,array('class'=>'form-control','placeholder'=>__('07 056 45890'),'required'=>'required'))); ?>
...
<?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/user/create.blade.php ENDPATH**/ ?>