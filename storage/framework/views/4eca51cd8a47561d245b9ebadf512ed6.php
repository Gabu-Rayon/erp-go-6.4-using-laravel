    ...
    <div class="proposal-header">
        <table>
            ...
            <tr style="border-bottom:1px solid var(--theme-color);">
                ...
                <td class="text-right">
                    <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: var(--theme-color);"><?php echo e(__('PROPOSAL')); ?></h3>
                </td>
            </tr>
            </tbody>
        </table>
...
<?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/proposal/templates/template8.blade.php ENDPATH**/ ?>