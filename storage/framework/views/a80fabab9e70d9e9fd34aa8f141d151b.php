        ...
        <nav class="navbar">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="<?php echo e($logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-light.png')); ?>" alt="logo" style="width: 90px">
        ...
        <section class="placedjob-section">
            <div class="container">
                <div class="section-title bg-light">
                    ...
                    <h2 class="h1 mb-3"> <span class="text-primary">+<?php echo e($totaljob); ?>  </span><?php echo e(__('Job openings')); ?></h2>
                    <p><?php echo e(__('Always looking for better ways to do things, innovate')); ?> <br> <?php echo e(__('and help people achieve their goals')); ?>.</p>
                </div>
                <div class="row g-4">
                    <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="job-card-body">
                            <div class="d-flex mb-3 align-items-center justify-content-between ">
                                ...
                                <span><?php echo e(!empty($job->branches)?$job->branches->name:''); ?> <i  class="ti ti-map-pin ms-1"></i></span>
                                <?php endif; ?>
                            </div>
                            <h5 class="mb-3">
                            ...
                            <div class="d-flex mb-3 align-items-start flex-column flex-xl-row flex-md-row flex-lg-column">
                                <span class="d-inline-block me-2"> <i class="ti ti-circle-plus "></i> <?php echo e($job->position); ?> <?php echo e(__('position available')); ?></span>
                            </div>
...
<?php /**PATH /home/chrisdroid/Desktop/projects/php/erp-go-6.4-using-laravel/resources/views/job/career.blade.php ENDPATH**/ ?>