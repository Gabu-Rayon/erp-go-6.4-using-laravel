                        ...
                        <div class="card-body table-border-style full-card">
                            <div class="project-info d-flex text-sm">
                                <div class="project-info-inner mr-3 col-4">
                                    ...
                                    <div class="project-amnt pt-1"><?php if(!empty($employee->salaryType)): ?><?php echo e($employee->salaryType->name); ?><?php else: ?> -- <?php endif; ?></div>
                                </div>
                                <div class="project-info-inner mr-3 col-4">
                                ...
                                <div class="project-info-inner mr-3 col-4">
                                    <b class="m-0"> <?php echo e(__('Account')); ?> </b>
                                    <div class="project-amnt pt-1"><?php if(!empty($employee->bankAccount)): ?><?php echo e($employee->bankAccount->bank_name); ?><?php else: ?> -- <?php endif; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-striped mb-0">
                                        ...
                                        <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($employee->name); ?></td>
                                                <td><?php echo e(!empty( $loan->loanOption)? $loan->loanOption->name:''); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/setsalary/employee_salary.blade.php ENDPATH**/ ?>