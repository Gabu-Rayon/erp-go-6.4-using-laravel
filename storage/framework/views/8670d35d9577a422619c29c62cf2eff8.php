...
<?php $__env->startSection('action-btn'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create announcement')): ?>
            <a href="#" data-url="<?php echo e(route('announcement.create')); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Create New Announcement')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"  class="btn btn-sm btn-primary">
                                        ...
                                        <td>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit announcement')): ?>
                                                <div class="action-btn bg-primary ms-2">
                                                    ...
                                                    <a href="#" data-url="<?php echo e(URL::to('announcement/'.$announcement->id.'/edit')); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Announcement')); ?>" class="x-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chrisdroid/Desktop/projects/php/erp-go-6.4-using-laravel/resources/views/announcement/index.blade.php ENDPATH**/ ?>