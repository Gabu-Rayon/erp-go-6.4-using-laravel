                ...
                <div class="card-body" data-autofill>
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <?php echo e(Form::select('customerName', $customer, '', ['class' => 'form-control select2 customer customerName', 'data-url' => route('invoice.custom.credit.getcustomerDetails'), 'required' => 'required'])); ?>
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Log::info('INVOUICIE')); ?>

                            <?php echo e(Log::info($invoices)); ?>

                            <?php echo e(Form::label('invoice', __('Invoice(*)'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::select('invoice', $invoices, '', ['class' => 'form-control select2', 'required' => 'required'])); ?>
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item data-clone>
                                <tr class="p-3 row">
                                    ...
                                    <td class="text-white ti ti-trash repeater-action-btn bg-danger ms-2"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chris-droid/Desktop/projects/erp-go-6.4-using-laravel/resources/views/creditNote/custom_create.blade.php ENDPATH**/ ?>