...
<?php $__env->startPush('css-page'); ?>
    <style>
        ...
        .form-check-input:checked+.toggle-text {
            content: "On";
        }

        .form-check-input:not(:checked)+.toggle-text {
            content: "Off";
        }
    </style>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/settings/index.blade.php ENDPATH**/ ?>