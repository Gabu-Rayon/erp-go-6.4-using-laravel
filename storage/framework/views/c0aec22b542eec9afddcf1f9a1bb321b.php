        ...
        function getEmployee(did) {
            $.ajax({
                ...
                success: function (data) {
                    $('#employee_id').empty();
                    $("#employee_div").html('');
                    $('#employee_div').append('<label for="employee" class="form-label"><?php echo e(__('Employee')); ?></label><select class="form-control select2" id="employee_id" name="employee_id"></select>');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/report/payroll.blade.php ENDPATH**/ ?>