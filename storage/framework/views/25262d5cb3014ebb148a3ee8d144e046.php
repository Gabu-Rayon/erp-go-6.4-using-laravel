                    ...
                    <div class="card-body table-border-style">
                        ...
                        <div class="table-responsive" id="quarterly">
                            <table class="table">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td colspan="5" class="text-dark"><span><?php echo e(__('Income = Revenue + Invoice :')); ?></span></td>
                                </tr>
                                <tr>
                        ...
                        <div class="table-responsive" id="yearly">
                            <table class="table">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td colspan="2" class="text-dark"><span><?php echo e(__('Income = Revenue + Invoice :')); ?></span></td>
                                </tr>
                                <tr>
                                    <td class="text-dark"><h6><?php echo e(__('Total')); ?></h6></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/report/income_summary.blade.php ENDPATH**/ ?>