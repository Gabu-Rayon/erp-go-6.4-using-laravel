...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a class="btn btn-sm btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button"
            ...
            title="<?php echo e(__('Filter')); ?>"><i class="ti ti-filter"></i>
        </a>
                                        ...
                                        <td class="Action">
                                            <span>
                                                ...
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="#" id="<?php echo e(route('invoice.link.copy', [$invoiceID])); ?>"
                                                ...
                                                <div class="action-btn bg-primary ms-2">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-toggle="tooltip" data-original-title="<?php echo e(__('Duplicate')); ?>"
