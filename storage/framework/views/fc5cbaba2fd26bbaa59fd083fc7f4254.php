                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <div class="col-12 text-end">
                                <a href="#" data-url="<?php echo e(route('job.on.board.create', $jobApplication->id)); ?>" data-title="<?php echo e(__('Add to Job OnBoard')); ?>" data-ajax-popup="true" class="btn-sm btn btn-primary">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-9">
                            <?php if(!empty($jobApplication->resume)): ?>
                                ...
                                <a href="<?php echo e(asset(Storage::url('uploads/job/resume')).'/'.$jobApplication->resume); ?>" download=""  target="_blank"><i class="ti ti-download text-white"></i></a>
                            </span>
                            <?php else: ?>
                                -
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/jobApplication/show.blade.php ENDPATH**/ ?>