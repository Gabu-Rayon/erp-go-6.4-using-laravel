...
<?php $__env->startSection('action-btn'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit job')): ?>
            <a href="<?php echo e(route('job.edit',$job->id)); ?>" data-url="" data-ajax-popup="true" data-title="<?php echo e(__('Edit Job')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>"  class="btn btn-sm btn-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table mt-3">
                            ...
                            <tr>
                                ...
                                <td class=""><?php echo e(!empty($job->branches)?$job->branches->bhfNm:__('All')); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <?php if($job->status=='active'): ?>
                                        <span class="p-2 px-3 rounded badge bg-primary"><?php echo e(App\Models\Job::$status[$job->status]); ?></span>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/job/show.blade.php ENDPATH**/ ?>