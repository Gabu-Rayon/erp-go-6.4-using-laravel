...
<div class="proposal-preview-main" id="boxes">
    <div class="proposal-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 30px; font-weight: bold; margin-bottom: 10px; color: <?php echo e($color); ?>;"><?php echo e(__('PROPOSAL')); ?></h3>
                    <p>
...
<?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/proposal/templates/template4.blade.php ENDPATH**/ ?>