...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(array('url' => 'expense','class'=>'w-100'))); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col employee">
                                <div class="form-group" id="employee-box">
                                    <?php echo e(Form::label('employee_id', __('Payee'),['class'=>'form-label'])); ?>

                                    <?php echo e(Form::select('employee_id', $employees,null, array('class' => 'form-control select','id'=>'employee','data-url'=>route('expense.employee')))); ?>
                            ...
                            <div class="col customer d-none">
                                <div class="form-group" id="customer-box">
                                    <?php echo e(Form::label('customer_id', __('Payee'),['class'=>'form-label'])); ?>
                            ...
                            <div class="col vendor d-none">
                                <div class="form-group" id="vender-box">
                                    <?php echo e(Form::label('vender_id', __('Payee'),['class'=>'form-label'])); ?>
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                <td width="25%" class="form-group pt-0">
                                    <?php echo e(Form::select('item', $product_services,'', array('class' => 'form-control select2 item','data-url'=>route('expense.product')))); ?>

                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        <?php echo e(Form::text('quantity','', array('class' => 'form-control quantity','placeholder'=>__('Qty')))); ?>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        <?php echo e(Form::text('price','', array('class' => 'form-control price','placeholder'=>__('Price')))); ?>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        <?php echo e(Form::text('discount','', array('class' => 'form-control discount','placeholder'=>__('Discount')))); ?>
                            ...
                            <tr>
                                ...
                                <td class="form-group">
                                    <div class="input-group ">
                                        <?php echo e(Form::text('amount','', array('class' => 'form-control accountAmount','placeholder'=>__('Amount')))); ?>
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("expense.index")); ?>';" class="btn btn-light">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/expense/create.blade.php ENDPATH**/ ?>