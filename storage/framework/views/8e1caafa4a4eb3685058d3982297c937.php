                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row g-3 flex-nowrap team-lists horizontal-scroll-cards">
                                    ...
                                    ?>
                                        <div class="col-auto">
                                            <img src="<?php echo e($logo . $avatar); ?>" alt="">
                                        ...
                                        <div class="col-md-6 col-sm-6 my-3 my-sm-0">
                                            <div class="d-flex align-items-start mb-3">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-info"><?php echo e($countUser); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="col-md-6 col-sm-6 my-3 my-sm-0">
                                            <div class="d-flex align-items-start mb-3">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-info"><?php echo e($activeJob); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="col-md-6 col-sm-6 my-3 my-sm-0">
                                            <div class="d-flex align-items-start mb-3">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-info"><?php echo e($countTrainer); ?></h4>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chrisdroid/Desktop/projects/php/erp-go-6.4-using-laravel/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>