            ...
            <div class="col-md-8">
                <div class="mt-2" id="multiCollapseExample1">
                    <div class="card" id="show_filter" style="display:none;">
                        <div class="card-body">
                            <?php echo e(Form::open(['route' => ['report.balance.sheet'], 'method' => 'GET', 'id' => 'report_balancesheet'])); ?>
                                    ...
                                    <div class="col-xl-3 mt-4">
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons"
                                            ...
                                            <label class="btn btn-primary month-label">
                                                <a href="<?php echo e(route('report.balance.sheet', ['vertical', 'collapse'])); ?>"
                                                    class="text-white" id="collapse"> <?php echo e(__('Collapse')); ?> </a>
                                            </label>

                                            <label class="btn btn-primary year-label active">
                                                <a href="<?php echo e(route('report.balance.sheet', ['vertical', 'expand'])); ?>"
                                    ...
                                    <div class="col-xl-9">
                                        <div class="row justify-content-end align-items-center">
                                            ...
                                            <div class="col-auto mt-4">
                                                ...
                                                <a href="<?php echo e(route('report.balance.sheet')); ?>"
                                                        ...
                                                        <?php if($record['account'] == 'parentTotal'): ?>
                                                            <div
                                                                ...
                                                                <div class="mb-2 account-arrow">
                                                                    <div class="">
                                                                        <a
                                                                            href="<?php echo e(route('report.balance.sheet', ['vertical', 'expand'])); ?>"><i
                                                            ...
                                                            <div
                                                                ...
                                                                <?php if($record['account'] == 'parent'): ?>
                                                                    <div class="mb-2 account-arrow">
                                                                        <div class="">
                                                                            <a
                                                                                href="<?php echo e(route('report.balance.sheet', ['vertical', 'collapse'])); ?>"><i
                                                                                    class="ti ti-chevron-down account-icon"></i></a>
                                                                        </div>
                                                                        <a href="<?php echo e(route('report.ledger', $record['account_id'])); ?>?account=<?php echo e($record['account_id']); ?>"
...
<?php $__env->startPush('script-page'); ?>
    <script>
        $(document).on('click', '#collapse', function() {
            view = "collapse";
            $.ajax({
                url: '<?php echo e(route('report.balance.sheet', 'vertical')); ?>',
                type: 'GET',
                data: {
                    "view": view,
                    ,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chrisdroid/Desktop/projects/php/erp-go-6.4-using-laravel/resources/views/report/balance_sheet.blade.php ENDPATH**/ ?>