...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <div class="d-inline-block mb-4">
            <?php echo e(Form::open(['route' => 'productservice.searchCodeListByDate', 'method' => 'POST', 'class' => 'w-100'])); ?>

            <?php echo csrf_field(); ?>
            <div class="form-group">
                <?php echo e(Form::label('SearchCodeListByDate', __('Search Date (ex- 01-Jan-2022)'), ['class' => 'form-label'])); ?>

                <?php echo e(Form::date('searchCodeListByDate', null, ['class' => 'form-control', 'required' => 'required'])); ?>
        ...
        <a href="<?php echo e(route('productservice.synccodelist')); ?>" class="btn btn-sm btn-primary sync" data-bs-toggle="tooltip"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chris-droid/Desktop/projects/erp-go-6.4-using-laravel/resources/views/productservice/getcodelist.blade.php ENDPATH**/ ?>