                        ...
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th> <?php echo e(__('Supplier Tin')); ?></th>
                                    <th><?php echo e(__('supplier BhfId')); ?></th>
                                    <th><?php echo e(__('Supplier Name')); ?></th>
                                     <th><?php echo e(__('Supplier InvcNo')); ?></th>
                                      <th><?php echo e(__('purchase Type Code')); ?></th>
                                       <th><?php echo e(__('RceiptTyCd')); ?></th>
                                        <th><?php echo e(__('Payment Type Code')); ?></th>
                                         <th><?php echo e(__('Purchase Status Code')); ?></th>
                                          <th><?php echo e(__('Confirm Date')); ?></th>
