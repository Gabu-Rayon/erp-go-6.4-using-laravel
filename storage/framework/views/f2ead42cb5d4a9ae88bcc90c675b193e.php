    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('designation',$designations,null,array('class'=>'form-control select','required'=>'required'))); ?>
...
<?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/indicator/create.blade.php ENDPATH**/ ?>