        ...
        <div class="col-md-12">
            ...
            <div class="choose-file form-group">
                <label for="attachment" class="form-label">
                    ...
                    <img id="image"  width="25%;" class="mt-3" src="<?php if($companyPolicy->attachment): ?><?php echo e($policyPath.$companyPolicy->attachment); ?><?php else: ?><?php echo e($logo.'user-2_1654779769.jpg'); ?><?php endif; ?>" />
...
<?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/companyPolicy/edit.blade.php ENDPATH**/ ?>