...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('insurancecode',null,array('class'=>'form-control font-style','placeholder'=>__('3447899 '),'required'=>'required'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('insurance_name',__('Insurance Name'),['class'=>'form-label'])); ?>

            <?php echo e(Form::text('insurancename',null,array('class'=>'form-control','placeholder'=>__('Enter Insurance Name')))); ?>

        </div> 
        <div class="form-group col-md-6">
            <?php echo e(Form::label('premium_rate',__('Premium Rate'),['class'=>'form-label'])); ?>

            <?php echo e(Form::number('premiumrate',null,array('class'=>'form-control','placeholder'=>__('i.e 100 ,200')))); ?>
