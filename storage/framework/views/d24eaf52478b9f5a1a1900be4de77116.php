                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td
                                    class="<?php echo e($unit->status == 1 ? 'bg-success text-white' : 'bg-danger text-white'); ?> p-100 text-center rounded-pill">
                                    <?php echo e($unit->status == 1 ? 'Active' : 'Inactive'); ?>
                                    ...
                                    <span>
                                        <div class="action-btn bg-primary ms-2">
                                            <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                data-url="<?php echo e(route('product-unit.edit',$unit->id)); ?>"
                                                data-ajax-popup="true" data-title="<?php echo e(__('Edit Unit')); ?>"
                                                data-toggle="tooltip"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/productServiceUnit/index.blade.php ENDPATH**/ ?>