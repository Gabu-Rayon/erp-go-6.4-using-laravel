    ...
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create branch')): ?>
            <a href="#" data-url="<?php echo e(route('branch.create')); ?>" data-ajax-popup="true"
                data-title="<?php echo e(__('Create New Branch')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\Desktop\chrisdroid\projects\erp-go-6.4-using-laravel\resources\views/branch/index.blade.php ENDPATH**/ ?>