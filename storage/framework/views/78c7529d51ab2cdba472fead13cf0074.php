            ...
            <div class="card-body table-border-style">
                    ...
                    <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $complaints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $complaint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td><?php echo e(!empty( $complaint->complaintFrom)? $complaint->complaintFrom->name:''); ?></td>
                                    <td><?php echo e(!empty($complaint->complaintAgainst)?$complaint->complaintAgainst->name:''); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chrisdroid/Desktop/projects/php/erp-go-6.4-using-laravel/resources/views/complaint/index.blade.php ENDPATH**/ ?>