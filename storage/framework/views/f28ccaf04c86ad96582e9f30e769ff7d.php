    ...
    <div class="row py-4">
        <div class="col-md-12">
            <div class="info text-sm">
                ...
                <span><?php echo e(!empty($appraisal->branches) ? $appraisal->branches->bhfNm : ''); ?></span>
            </div>
        </div>
...
<?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/appraisal/show.blade.php ENDPATH**/ ?>