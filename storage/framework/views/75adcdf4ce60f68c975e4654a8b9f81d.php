...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(['route' => ['invoice.custom.credit.note'], 'mothod' => 'post'])); ?>
                          ...
                          <tbody class="ui-sortable" data-repeater-item data-clone>
                            <tr class="row p-3">
                                ...
                                <td class="form-group col-md-4">
                                    ...
                                    <?php echo e(Form::text('unitPrice', '', ['class' => 'form-control unitPrice', 'required' => true])); ?>

                                </td>
                                <td class="form-group col-md-4">
                                    <?php echo e(Form::label('quantity', __('Quantity'), ['class' => 'form-label'])); ?>

                                    <?php echo e(Form::text('quantity', '', ['class' => 'form-control quantity', 'required' => true])); ?>
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("credit.note")); ?>';" class="btn btn-light">
