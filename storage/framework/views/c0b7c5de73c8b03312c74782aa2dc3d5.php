...
<div class="invoice-preview-main" id="boxes">
    <div class="invoice-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 30px; font-weight: bold; margin-bottom: 10px; color: <?php echo e($color); ?>;"><?php echo e(__('INVOICE')); ?></h3>
                    <p>
                ...
                <td>
                    ...
                    <table class="no-space">
                        ...
                        <tr>
                            <td><?php echo e(__('Issue Date')); ?>:</td style="color: <?php echo e($color); ?>;">
...
<?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/invoice/templates/template4.blade.php ENDPATH**/ ?>