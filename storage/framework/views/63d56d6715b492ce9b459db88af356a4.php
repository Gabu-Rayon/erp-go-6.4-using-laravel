                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control summernote-simple-2" name="description" id="exampleFormControlTextarea1" rows="15"><?php echo e($job->description); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-fluid">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <textarea class="form-control summernote-simple" name="requirement" id="exampleFormControlTextarea2" rows="8"><?php echo e($job->requirement); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/job/edit.blade.php ENDPATH**/ ?>