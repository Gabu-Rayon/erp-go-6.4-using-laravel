...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-3 mb-4">
                        <div class="card text-center card-2">
                            <div class="card-body">
                                <h5 class="card-title">Branch User ID: <?php echo e($user['branchUserId']); ?></h5>
                                <p class="card-text">Branch User Name: <?php echo e($user['branchUserName']); ?></p>
                                <p class="card-text">Address: <?php echo e($user['address']); ?></p>
                                <p class="card-text">Is Active: <?php echo e($user['isUsed'] ? 'Yes' : 'No'); ?></p>
                            </div>
                        </div>
                    </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/user/index.blade.php ENDPATH**/ ?>