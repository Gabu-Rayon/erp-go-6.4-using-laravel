<?php if(!empty($customer)): ?>
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="bill-to">
                <?php if(!empty($customer['customerName'])): ?>
                    <small>
                        <span>Name: <?php echo e($customer['customerName']); ?></span><br>
                        <span>TIN: <?php echo e($customer['customerTin']); ?></span><br>
                        <span>Customer No: <?php echo e($customer['customerNo']); ?></span><br>
                        <span>Contact: <?php echo e($customer['telNo']); ?></span><br>
        ...
        <div class="col-md-2">
            <a href="#" id="remove" class="my-3 btn btn-sm btn-danger"><?php echo e(__(' Remove')); ?></a>
        </div>
    </div>
<?php endif; ?>
<?php /**PATH /home/chris-droid/Desktop/projects/erp-go-6.4-using-laravel/resources/views/invoice/customer_detail.blade.php ENDPATH**/ ?>