                        ...
                        <?php if(isset($projects) && !empty($projects) && count($projects) > 0): ?>
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class=""> 
                                        <h6 class="mb-0 text-success"><?php echo e($project->project_progress($project,$last_task->id)['percentage']); ?></h6>
                                        <div class="progress mb-0"><div class="progress-bar bg-<?php echo e($project->project_progress($project,$last_task->id)['color']); ?>" style="width: <?php echo e($project->project_progress($project,$last_task->id)['percentage']); ?>;"></div>
                                        </div>
                                    </td>
                                    <td class="">
                                    ...
                                    <td class="">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project')): ?>
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="<?php echo e(route('project_report.show', $project->id)); ?>" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('View Project Report')); ?>" data-original-title="<?php echo e(__('Detail')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chrisdroid/Desktop/projects/php/erp-go-6.4-using-laravel/resources/views/project_report/index.blade.php ENDPATH**/ ?>