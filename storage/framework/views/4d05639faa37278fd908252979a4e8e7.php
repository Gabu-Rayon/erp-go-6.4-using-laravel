        ...
        <div class="proposal-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
            <table>
                <tbody>
                    <tr>
                        <td>
                            <img class="proposal-logo" src="<?php echo e(asset($img)); ?>" alt="Logo">
                        </td>
                        <td class="text-right">
                            ...
                            <table class="no-space" style="width: 45%;margin-left: auto;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <?php echo e(Utility::proposalNumberFormat($settings, $proposal->proposal_id)); ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo e(__('Issue Date')); ?>:</td>
                                        <td class="text-right">
                                            <?php echo e(Utility::dateFormat($settings, $proposal->issue_date)); ?></td>
                                    </tr>
                                    ...
                                    <?php if(!empty($customFields) && count($proposal->customField) > 0): ?>
                                        <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td> <?php echo e(!empty($proposal->customField) ? $proposal->customField[$field->id] : '-'); ?>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td><?php echo e(__('Total')); ?>:</td>
                                    <td><?php echo e(Utility::priceFormat($settings, $proposal->getSubTotal() - $proposal->getTotalDiscount() + $proposal->getTotalTax())); ?>
...
<?php /**PATH /home/chris-droid/Desktop/projects/erp-go-6.4-using-laravel/resources/views/proposal/templates/template1.blade.php ENDPATH**/ ?>