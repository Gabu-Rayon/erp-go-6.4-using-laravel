        ...
        <div class="col-md-4 col-lg-4 col-xl-4 mb-4">
            <div class="card customer-detail-box customer_card">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0"><?php echo e($customer['customerName']); ?></p>
                    <p class="card-text mb-0"><?php echo e($customer['email']); ?></p>
                    <p class="card-text mb-0"><?php echo e($customer['telNo']); ?></p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/customer/show.blade.php ENDPATH**/ ?>