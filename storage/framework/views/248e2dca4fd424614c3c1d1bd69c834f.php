            ...
            <div class="card-body table-border-style">
                    ...
                    <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $appraisals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appraisal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo e(!empty($appraisal->branches)?$appraisal->branches->bhfNm:''); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit appraisal')): ?>
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="#" data-url="<?php echo e(route('appraisal.edit',$appraisal->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Appraisal')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit Appraisal')); ?>" class="mx-3 btn btn-sm align-items-center">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/appraisal/index.blade.php ENDPATH**/ ?>