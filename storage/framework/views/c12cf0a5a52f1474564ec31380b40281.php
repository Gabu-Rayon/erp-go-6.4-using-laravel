    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5><?php echo e(__('Main Item: ')); ?> <?php echo e(\App\Models\ProductService::where('kraItemCode', $compositionList->mainItemCode)->first()->itemNm ?? null); ?></h5>
            </div>
                    ...
                    <table class="table datatable">
                        ...
                        <?php $__currentLoopData = $compositionItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              ...
                              <td><?php echo e(optional(\App\Models\ProductService::where('kraItemCode', $item->compoItemCode)->first())->itemNm ?? null); ?></td>
