                ...
                <div class="col-lg-5 ps-lg-0">
                    <div class="card m-0">
                        <div class="card-header p-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <?php echo e(Form::select('customer_id', $customers,$customer, array('class' => 'form-control select customer_select','id'=>'customer','required'=>'required'))); ?>
                                ...
                                <div class="col-md-6">
                                    <?php echo e(Form::select('warehouse_id', $warehouses,$warehouseId, array('class' => 'form-control select warehouse_select ','id'=>'warehouse','required'=>'required'))); ?>
                        ...
                        <div class="card-body carttable cart-product-list carttable-scroll" id="carthtml">
                            <?php $total = 0; $netPrice = 0; $discount = 0;?>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <div class="d-flex text-end justify-content-end align-items-center">
                                                ...
                                                <?php echo e(Form::number('discount',$discount, array('class' => ' form-control discount','required'=>'required','placeholder'=>__('Discount')))); ?>
...
<?php /**PATH /home/chrisdroid/Desktop/projects/php/erp-go-6.4-using-laravel/resources/views/pos/index.blade.php ENDPATH**/ ?>