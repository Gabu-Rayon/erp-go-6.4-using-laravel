...
<div class="proposal-preview-main" id="boxes">
    <div class="proposal-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: inline-block; text-transform: uppercase; font-size: 40px; font-weight: bold; border-top: 5px solid var(--theme-color); padding-top: 5px;"><?php echo e(__('PROPOSAL')); ?></h3>
...
<?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/proposal/templates/template10.blade.php ENDPATH**/ ?>