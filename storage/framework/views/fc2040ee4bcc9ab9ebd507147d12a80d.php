...
<li class="breadcrumb-item"><a
        href="<?php echo e(route('productservice.index')); ?>"><?php echo e(__('Products & Services')); ?></a></li>
                            ...
                            <tr class="row p-3">
                                ...
                                <td class="form-group col-md-3">
                                    <div class="form-group">
                                        ...
                                        >>>>>>> 075651a6fae6ef5e4d76518983d7d9d56571746d
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check form-check-inline">
                                                        <input type="radio" class="form-check-input type"
                                                            id="customRadio<?php echo e($loop->index); ?>"
                                                            name="itemTypeCode" value="<?php echo e($value); ?>"
