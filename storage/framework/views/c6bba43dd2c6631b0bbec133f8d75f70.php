...
$(document).ready(function() {
    ...
    $(document).on('keyup change', '.taxCode', function() {
        ...
        $(el).closest('tr').find('.discountAmount').val(parseFloat(discountAmount));
        $(el).closest('tr').find('.amount').html(parseFloat(finalAmount));
        $(el).closest('tr').find('.taxTypeCode').val($(el).closest('tr').find(
            '.taxCode option:selected').text());
    });
...
<div class="row">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><strong><?php echo e(__('Sub Total')); ?>
                                        (<?php echo e(\Auth::user()->currencySymbol()); ?>)</strong>
                                </td>
    ...
    <div class="modal-footer">
        <input type="button" value="<?php echo e(__('Cancel')); ?>"
            onclick="location.href = '<?php echo e(route('invoice.index')); ?>';" class="btn btn-light">
