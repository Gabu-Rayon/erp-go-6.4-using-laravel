                            ...
                            <div class="row invoice-title mt-2">
                                ...
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                    <h4 class="invoice-number">
                                        <?php echo e($invoice->response_invoiceNo); ?></h4>
                                </div>
                                <div class="col-12">
                                    <hr>
                                </div>
 ...
 -->
                                <div class="col ">
                                    <small>
                                        ...
                                        <p><i>Trader Invoice No : </i><?php echo e($invoice->response_trderInvoiceNo); ?></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\projects\erp-go-6.4-using-laravel\resources\views/invoice/view.blade.php ENDPATH**/ ?>