...
<div class="proposal-preview-main"  id="boxes">
    <div class="proposal-header" style="">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 20px; font-weight: bold; color: <?php echo e($color); ?>;"><?php echo e(__('PROPOSAL')); ?></h3>
    ...
    <div class="proposal-body">
        ...
        <table class=" proposal-summary" style="border-bottom:1px solid <?php echo e($color); ?>;">
...
<?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/proposal/templates/template3.blade.php ENDPATH**/ ?>