...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <a href="<?php echo e(route('invoice.custom.credit.note')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Add Direct Credit Note')); ?>"
            data-title="<?php echo e(__('Add Direct Credit Note')); ?>" class="btn btn-sm btn-primary">
                                ...
                                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!empty($invoice->creditNote)): ?>
                                        <?php $__currentLoopData = $invoice->creditNote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $creditNote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                <td class="Id">
                                                    <a href="<?php echo e(route('invoice.show', \Crypt::encrypt($creditNote->invoice))); ?>"
                                                        class="btn btn-outline-primary"><?php echo e(AUth::user()->invoiceNumberFormat($invoice->invoice_id)); ?></a>
                                                </td>
                                                <td><?php echo e(!empty($invoice->customer) ? $invoice->customer->customerName : '-'); ?>

                                                </td>
                                                <td><?php echo e(Auth::user()->dateFormat($creditNote->salesDate)); ?></td>
                                                <td><?php echo e(Auth::user()->priceFormat($creditNote->amount)); ?></td>
                                                <td><?php echo e(!empty($creditNote->remark) ? $creditNote->remark : '-'); ?></td>
                                                <td>

                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="<?php echo e(route('invoice.show.credit.note', \Crypt::encrypt($creditNote->id))); ?>"
                                                    ...
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a data-url="<?php echo e(route('invoice.edit.credit.note', [$creditNote->invoice, $creditNote->id])); ?>"
                                                            ...
                                                            data-title="<?php echo e(__('Edit Credit Note')); ?>" href="#"
                                                            class="mx-3 btn btn-sm align-items-center"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-go-6.4-using-laravel\resources\views/creditNote/index.blade.php ENDPATH**/ ?>