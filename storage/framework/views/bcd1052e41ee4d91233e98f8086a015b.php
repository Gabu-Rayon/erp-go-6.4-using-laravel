<?php echo e(Form::open(array('route' => array('purchase.payment', $purchase->id),'method'=>'post','enctype' => 'multipart/form-data'))); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            <?php echo e(Form::number('amount',$purchase->getDue(), array('class' => 'form-control','required'=>'required','step'=>'0.01'))); ?>
...
<?php /**PATH C:\Users\Developer\Desktop\apps\erp-go-6.4-using-laravel\resources\views/purchase/payment.blade.php ENDPATH**/ ?>