...
class WarehouseTransferController extends Controller
{
    ...
    public function create()
    {
        ...
        $ware_pro = WarehouseProduct::join('product_services', 'warehouse_products.itemCd', '=', 'product_services.itemCd')
                             ->pluck('product_services.itemNm', 'warehouse_products.itemCd');
