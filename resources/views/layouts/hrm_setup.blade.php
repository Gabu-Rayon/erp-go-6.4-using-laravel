<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        <a href="{{ route('branch.index') }}" class="list-group-item list-group-item-action border-0 {{ (request()->is('branch*') && !request()->is('branchuser*') ? 'active' : '') }}">{{__('Branch')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>


        <a href="{{ route('branchuser.index') }}" class="list-group-item list-group-item-action border-0 {{ (request()->is('branchuser*') ? 'active' : '')}}">{{__('Branch User')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
