...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Add Sales Credit Note') }}</li>
@endsection
@push('script-page')
...
@section('content')
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-4">
                            {{ Form::label('orgInvoiceNo', __('Original Invoice Number (*)'),['class'=>'form-label']) }}
                            {{ Form::text('orgInvoiceNo', '', array('class' => 'form-control orgInvoiceNo','required'=>'required')) }}
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {{ Form::number('creditNoteReason', '', array('class' => 'form-control creditNoteReason')) }}
                        </div>
                        <div class="form-group col-md-4">
                            {{ Form::label('creditNoteDate', __('Credit Note Date'),['class'=>'form-label']) }}
                            {{ Form::date('creditNoteDate', '', array('class' => 'form-control creditNoteDate')) }}
                        </div>
                        <div class="form-group col-md-4">
        ...
        <div class="modal-footer">
            <input type="button" value="{{ __('Cancel') }}" onclick="location.href = '{{ route('salescreditnote.index') }}';"
                class="btn btn-light">
