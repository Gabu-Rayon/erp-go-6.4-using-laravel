...
@section('content')
    ...
    <div class="col-md-3 mb-4">
                        <div class="card text-center card-2">
                            <div class="card-body">
                                <h5 class="card-title">Branch User ID: {{ $user['branchUserId'] }}</h5>
                                <p class="card-text">Branch User Name: {{ $user['branchUserName'] }}</p>
                                <p class="card-text">Address: {{ $user['address'] }}</p>
                                <p class="card-text">Is Active: {{ $user['isUsed'] ? 'Yes' : 'No' }}</p>
                            </div>
                        </div>
                    </div>
    @endforeach
