                                    ...
                                    <div class="col">
                                        <small>
                                            ...
                                            @if ($purchase->status == 0)
                                                <span
                                                    class="badge bg-primary">{{ __(\App\Models\Bill::$statues[$purchase->status]) }}</span>
                                            @elseif($purchase->status == 1)
                                                <span
                                                    class="badge bg-warning">{{ __(\App\Models\Bill::$statues[$purchase->status]) }}</span>
                                            @elseif($purchase->status == 2)
                                                <span
                                                    class="badge bg-danger">{{ __(\App\Models\Bill::$statues[$purchase->status]) }}</span>
                                            @elseif($purchase->status == 3)
                                                <span
                                                    class="badge bg-info">{{ __(\App\Models\Bill::$statues[$purchase->status]) }}</span>
                                            @elseif($purchase->status == 4)
                                                <span
                                                    class="badge bg-success">{{ __(\App\Models\Bill::$statues[$purchase->status]) }}</span>
                                            @endif
                                        </small>
                                    </div>
