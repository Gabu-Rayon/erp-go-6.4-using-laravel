                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-12" id="vender-box">
                            ...
                            {{ Form::select('supplierName', $suppliers, null, ['class' => 'form-control select2 suppliers-field', 'required' => 'required', 'hidden' => false]) }}
                        </div>
                        <div class="form-group col-md-4" id="vender-box">
                            {{ Form::label('supplierTin', __('Supplier Tin'), ['class' => 'form-label']) }}
                            {{ Form::text('supplierTin', null, ['class' => 'form-control tin-field', 'required' => 'required', 'disabled' => true, 'readonly' => true]) }}
                        </div>
                        <div class="form-group col-md-4" id="vender-box">
                            {{ Form::label('supplierBhfId', __('Supplier BhfId'), ['class' => 'form-label']) }}
                            {{ Form::number('supplierBhfId', null, ['class' => 'form-control bhfid-field', 'required' => 'required', 'disabled' => true, 'readonly' => true]) }}
                        </div>
                        <div class="form-group col-md-4" id="vender-box">
                            {{ Form::label('supplierInvNo', __('Supplier Invoice No'), ['class' => 'form-label']) }}
                            {{ Form::number('supplierInvNo', null, ['class' => 'form-control invno-field', 'required' => 'required', 'disabled' => true, 'readonly' => true]) }}
                        </div>
                        <div class="form-group col-md-4" id="vender-box">
                            {{ Form::label('purchTypeCode', __('Purchase Type Code'), ['class' => 'form-label']) }}
                            {{ Form::text('purchTypeCode', null, ['class' => 'form-control bhfid-field']) }}
                        </div>
                        <div class="form-group col-md-4" id="vender-box">
                            {{ Form::label('purchStatusCode', __('Purchase Status Code'), ['class' => 'form-label']) }}
                            {{ Form::text('purchStatusCode', null, ['class' => 'form-control invno-field']) }}
                        </div>
                        <div class="form-group col-md-4" id="vender-box">
                            {{ Form::label('pmtTypeCode', __('Payment Type Code'), ['class' => 'form-label']) }}
                            {{ Form::text('pmtTypeCode', null, ['class' => 'form-control invno-field']) }}
                        </div>
                             ...
                             <tr>
                                <td colspan="2">
                                      {{ Form::label('discountRate', __('Discount Rate (%)'), ['class' => 'form-label']) }}
                                        {{ Form::number('discountRate', null, ['class' => 'form-control discount-rate-field', 'required' => 'required']) }}
                                </td>
                                <td colspan="2">
                                      {{ Form::label('discountAmt', __('Discount Amt'), ['class' => 'form-label']) }}
                                        {{ Form::number('DiscountAmt', null, ['class' => 'form-control discount-amount-field', 'required' => 'required', 'disabled' => 'disabled', 'readonly' => true]) }}
                                </td>
                                <td colspan="2">
                                      {{ Form::label('itemExprDt', __('item Expire Date'), ['class' => 'form-label']) }}
                                      {{ Form::date('itemExprDt', null, ['class' => 'form-control', 'required' => 'required']) }}
                                </td>
                            </tr>
                            <tr>
