                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    <td width="25%" class="form-group pt-1">
                                        ...
                                        <!-- {{ Form::select('itemCode', $product_services_Codes, null, ['class' => 'form-control select2 itemCode', 'required' => 'required']) }} -->

                                        <!-- {{ Form::select('itemCode', $product_services_Codes, '', ['class' => 'form-control select2 itemCode', 'required' => 'required']) }} -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- {{ Form::text('unitPrice', '', ['class' => 'form-control unitPrice', 'required' => 'required', 'placeholder' => __('unitPrice'), 'required' => 'required']) }} -->


                                        {{ Form::text('unitPrice', null, ['class' => 'form-control unitPrice', 'id' => 'unit_price', 'required' => 'required', 'placeholder' => __('unitPrice'), 'required' => 'required']) }}
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <div class="form-group">
                                            {{ Form::text('orgnNatCd', null, ['class' => 'form-control item_standard_name', 'rows' => '2', 'placeholder' => __('Country of Origin')]) }}
                                        </div>
                                    </td>
                                    <td colspan="5"></td>
