    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5>{{ __('Main Item: ') }} {{ \App\Models\ProductService::where('kraItemCode', $compositionList->mainItemCode)->first()->itemNm ?? null }}</h5>
            </div>
                    ...
                    <table class="table datatable">
                        ...
                        @foreach ($compositionItems as $item)
                            <tr>
                              ...
                              <td>{{ optional(\App\Models\ProductService::where('kraItemCode', $item->compoItemCode)->first())->itemNm ?? null }}</td>
