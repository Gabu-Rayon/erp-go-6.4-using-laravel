                    ...
                    <div class="row">
                            <div class="form-group" id="customer-box">
                              {{ Form::label('customer_id', __('Customer'),['class'=>'form-label']) }}
                                {{ Form::select('customer_id', $customers,'', array('class' => 'form-control customer_id select2','id'=>'customer','data-url'=>route('invoice.customer'),'required'=>'required')) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    {{ Form::select('isStockIOUpdate', ['true' => 'Yes', 'false' => 'No'], null, ['class' => 'form-control select2']) }}                                </div>
                                <div class="form-group col-md-4">
                    ...
                    <div class="table-responsive">
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                ...
                                {{ Form::select('itemCode', $product_services,'', array('class' => 'form-control select2 itemCode','id'=>'itemCode','data-url'=>route('invoice.product'),'required'=>'required')) }}
