        ...
        <div class="pos-header" style="background: {{ $color }};color:{{ $font_color }}">
            <table>
                <tbody>
                    <tr>
                        <td>
                            <img class="pos-logo" src="{{ asset($img) }}" alt="">
                        </td>
                        <td class="text-right">
                        ...
                        <td>
                            <table class="no-space" style="width: 45%;margin-left: auto;">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number') }}:</td>
                                        <td class="text-right">{{ Utility::posNumberFormat($settings, $pos->pos_id) }}
                                        </td>
                                    </tr>

                                    <tr>
                                        <td>{{ __('Issue Date') }}:</td>
                                        <td class="text-right">{{ Utility::dateFormat($settings, $pos->issue_date) }}
                                        </td>
                                    </tr>
                                    ...
                                    @if (!empty($customFields) && count($pos->customField) > 0)
                                        @foreach ($customFields as $field)
                                            <tr>
                                                <td>{{ $field->name }} :</td>
                                                <td> {{ !empty($pos->customField) ? $pos->customField[$field->id] : '-' }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td>{{ __('Total') }}:</td>
                                    @if (!empty($posPayment->discount))
                                        <td>{{ Utility::priceFormat($settings, $posPayment->amount - $posPayment->discount) }}
                                        </td>
                                    @else
                                        <td>{{ Utility::priceFormat($settings, $posPayment->amount) }}</td>
                                    @endif
