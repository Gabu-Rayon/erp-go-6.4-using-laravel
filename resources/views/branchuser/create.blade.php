{{Form::open(array('url'=>'branchuser','method'=>'post'))}}
<div class="modal-body">
    <div class="row">
            <div class="form-group col-6">
                {{Form::label('branchUserName',__('Branch User Name'),['class'=>'form-label'])}}
                {{Form::text('branchUserName',null,array('class'=>'form-control','placeholder'=>__('Enter Branch User Name')))}}
            ...
            <div class="form-group col-6">
                ...
                {{Form::text('contactNo',null,array('class'=>'form-control','placeholder'=>__('0720045000')))}}
                @error('contact_no')
                <span class="invalid-name" role="alert">
                    <strong class="text-danger">{{ $message }}</strong>
                </span>
