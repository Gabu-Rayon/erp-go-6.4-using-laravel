        ...
        function getEmployee(did) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#employee_id').empty();
                    $("#employee_div").html('');
                    $('#employee_div').append('<label for="employee" class="form-label">{{__('Employee')}}</label><select class="form-control select2" id="employee_id" name="employee_id[]"  multiple></select>');
